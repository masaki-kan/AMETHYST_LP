...
var TourActionTrigger = (0, react.forwardRef)((props, ref) => {
	...
	const mergedProps = (0, _zag_js_react.mergeProps)(tour.getActionTriggerProps(actionTriggerProps), localProps);
