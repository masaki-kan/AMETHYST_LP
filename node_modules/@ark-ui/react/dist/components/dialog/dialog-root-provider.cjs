...
var DialogRootProvider = (props) => {
	const [presenceProps, { value: dialog, children }] = require_split_presence_props.splitPresenceProps(props);
	const [renderStrategyProps] = require_render_strategy.splitRenderStrategyProps(presenceProps);
	const presence = require_use_presence.usePresence((0, _zag_js_react.mergeProps)({ present: dialog.open }, presenceProps));
