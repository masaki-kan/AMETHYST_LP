...
var HoverCardContent = (0, react.forwardRef)((props, ref) => {
	const hoverCard = require_use_hover_card_context.useHoverCardContext();
	const presence = require_use_presence_context.usePresenceContext();
	const mergedProps = (0, _zag_js_react.mergeProps)(hoverCard.getContentProps(), presence.getPresenceProps(), props);
