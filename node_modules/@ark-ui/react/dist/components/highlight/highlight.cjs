...
var splitHighlightBaseProps = require_create_split_props.createSplitProps();
var Highlight = (props) => {
	...
	const chunks = require_use_highlight.useHighlight(highlightProps);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children: chunks.map(({ text, match }, i) => match ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("mark", {
		...localProps,
		children: text
