...
const RootBase = React.forwardRef(
  function RootBase2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(codeBlockContext.CodeBlockContextProvider, { value: context, children: /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ref,
        "data-has-focused": react.dataAttr(Boolean(meta?.focusedLineNumbers?.length)),
        "data-has-diff": react.dataAttr(
          Boolean(meta?.addedLineNumbers?.length) || Boolean(meta?.removedLineNumbers?.length)
        ),
        "data-has-line-numbers": react.dataAttr(Boolean(meta?.showLineNumbers)),
        ...rest,
  ...
  function ContentBase2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      factory.ark.div,
      {
        ...
        "data-expanded": react.dataAttr(!collapsible.collapsed),
...
const CodeText = React.forwardRef(
  function CodeText2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      factory.ark.code,
      {
        "data-plaintext": react.dataAttr(!highlighted?.highlighted),
        "data-has-focused": react.dataAttr(Boolean(meta?.focusedLineNumbers?.length)),
        "data-has-diff": react.dataAttr(
          Boolean(meta?.addedLineNumbers?.length) || Boolean(meta?.removedLineNumbers?.length)
        ),
        "data-has-line-numbers": react.dataAttr(Boolean(meta?.showLineNumbers)),
        "data-word-wrap": react.dataAttr(Boolean(meta?.wordWrap)),
        ref,
        ...props,
        ...codeContentProps
      }
