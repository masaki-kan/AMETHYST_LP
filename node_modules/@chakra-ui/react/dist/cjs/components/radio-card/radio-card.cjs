...
const RadioCardItemControl = React.forwardRef(function RadioCardItemControl2(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      ref,
      "data-focus": react.dataAttr(api.focused),
      "data-disabled": react.dataAttr(api.disabled),
      "data-state": api.checked ? "checked" : "unchecked",
      "data-hover": react.dataAttr(api.hovered),
      "data-active": react.dataAttr(api.active),
      "data-invalid": react.dataAttr(api.invalid),
      ...props,
