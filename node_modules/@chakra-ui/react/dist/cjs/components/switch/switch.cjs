...
const SwitchIndicator = React.forwardRef(function SwitchIndicator2(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      ref,
      "data-checked": react.dataAttr(api.checked),
      ...rest,
...
const SwitchThumbIndicator = React.forwardRef(function SwitchThumbIndicator2(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(factory.chakra.span, { ref, "data-checked": react.dataAttr(api.checked), ...rest, children: api.checked ? children : fallback });
});
