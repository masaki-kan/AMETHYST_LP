...
const baseItemStyle = config.defineStyle({
  display: "flex",
  alignItems: "center",
...
const baseTextStyle = config.defineStyle({
  flex: "1"
});
const subtleVariantStyle = config.defineStyle({
  _selected: {
    bg: "colorPalette.subtle",
    color: "colorPalette.fg"
  }
});
const solidVariantStyle = config.defineStyle({
  _selected: {
    layerStyle: "fill.solid"
  }
});
const treeViewSlotRecipe = config.defineSlotRecipe({
  slots: treeView.treeViewAnatomy.keys(),
